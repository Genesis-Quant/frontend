...
type SecondaryQueryControlsPanelProps = {
  completionTables: SqlTableSchema[];
  loading: boolean;
  running: boolean;
...
export default function SecondaryQueryControlsPanel({ completionTables, loading, running, selectedIds, sources, sql, onRefresh, onRun, onSql, onToggle }: SecondaryQueryControlsPanelProps) {
