...
import type { DslCatalog, FactorAnalysisParameters, FactorProject, FactorVersionListItem } from "@/types/factor";
...
export default function FactorAnalysisControlsPanel({ activeWorkflow, catalog, displayedParameters, displayedState, displayedWorkflowInstanceId, dslValid, project, projectId, queueCount, readOnly, selectedVersion, stopping, submitting, workflowState, versions, onAnalyze, onCandidateReport, onCompare, onContinue, onDeleteVersion, onLogs, onOpenQueue, onParameters, onQueue, onRenameProject, onRenameVersion, onSave, onShowParameters, onStop, onValidity, onVersion }: FactorAnalysisControlsPanelProps) {
