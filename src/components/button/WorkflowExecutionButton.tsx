...
type WorkflowExecutionButtonProps = {
  active: boolean;
  className?: string;
  disabled?: boolean;
  label: string;
...
export default function WorkflowExecutionButton({ active, className, disabled = false, label, onRun, onStop, stopping, submitting }: WorkflowExecutionButtonProps) {
