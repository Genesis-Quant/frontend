...
export default function AnalysisWorkspace({ backTo, children, sidebar, sidebarLabel = "分析参数" }: AnalysisWorkspaceProps) {
  ...
  return <div className={cn(
    ...
    <aside className="relative flex min-w-0 flex-col border-b bg-muted/15 xl:sticky xl:top-16 xl:z-40 xl:h-[calc(100dvh-4rem)] xl:self-start xl:border-b-0 xl:border-r">
