...
import type { TaskActionResponse, TaskLog, TaskLogScope } from "@/types/task";

export const tasksApi = {
  logs: (workflowInstanceId: number, taskInstanceId: number, skipLineNum = 0, limit = 500, scope: TaskLogScope = "full", cursor?: string | null) => client.get<TaskLog>(`/tasks/${taskInstanceId}/logs`, { params: { workflow_instance_id: workflowInstanceId, skip_line_num: skipLineNum, limit, scope, ...cursor ? { cursor } : {} } }),
