...
export default function BacktestDetailPage() {
  ...
  return <>
    ...
    <FeeAnalysisDialog creationDisabled={displayedParameters?.market_source === "snapshot"} open={feeAnalysisOpen} projectId={projectId} projectTitle={project.title} version={selectedVersion} onOpenChange={setFeeAnalysisOpen} />
